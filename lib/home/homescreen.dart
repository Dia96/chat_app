        ...
        child: Scaffold(floatingActionButton: FloatingActionButton.extended(
          ...
          appBar: AppBar(elevation: 10, title: customSearchBar,
            actions: <Widget>[IconButton(onPressed: () {setState(() {
              ...
              toolbarHeight: 140, backgroundColor: Colors.cyan[700],
              bottom: TabBar(isScrollable: true, indicatorColor: SecondaryColor,
              indicatorWeight: 5.0, onTap: (index) {},
              tabs: <Widget>[
                Tab(child: Container(padding: EdgeInsets.all(13),
